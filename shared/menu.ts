...
export const MENU_CATEGORIES: MenuCategory[] = [
  {
    ...
    items: [
      {
        id: "app-battered-mushrooms",
        name: "Battered Mushrooms",
        description: "Golden beer-battered mushrooms, deep-fried crispy and served with dip",
        priceCents: 1200,
        category: "appetizers",
        tags: ["vegetarian"],
      ...
      },
      {
        ...
        description: "Breaded mozzarella sticks fried until gooey, served with marinara",
        priceCents: 1000,
        category: "appetizers",
        tags: ["vegetarian"],
      ...
      },
      {
        ...
        description: "Breaded jalapeños stuffed with cream cheese, fried golden and crispy",
        priceCents: 1200,
        category: "appetizers",
      ...
      },
      {
        ...
        name: "Pickle Spears",
        description: "Battered dill pickle spears, deep-fried with a tangy crunch",
        priceCents: 900,
        category: "appetizers",
        tags: ["vegetarian"],
      ...
      },
      {
        ...
        description: "Fresh cheese curds battered and fried until melty inside",
        priceCents: 1250,
        category: "appetizers",
        popular: true,
        tags: ["vegetarian"],
      ...
      },
      {
        ...
        description: "Creamy mac & cheese rolled, breaded, and fried golden",
        priceCents: 850,
        category: "appetizers",
        tags: ["vegetarian"],
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        id: "burger-chicken",
        name: "Chicken Burger",
        description: "Crispy chicken patty with lettuce, tomato, onion, pickle & mayo on a toasted bun",
        priceCents: 1250,
        category: "burgers",
      },
      {
    ...
    items: [
      {
        ...
        description: "Four crispy breaded chicken fingers served with golden fries and dipping sauce",
        priceCents: 1500,
        category: "chicken",
        popular: true,
